...
namespace Phobos.UI.Controls
{
    public sealed partial class BrowserTitleBar : UserControl
    {
        ...
        public List<XamlUICommand> Commands
        {
            get => (List<XamlUICommand>)GetValue(CommandsProperty);
            set => SetValue(CommandsProperty, value);
        }

        public static readonly DependencyProperty CommandsProperty =
            DependencyProperty.Register(nameof(Commands), typeof(List<XamlUICommand>), typeof(BrowserTitleBar), null);
